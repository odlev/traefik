...
| <a id="opt-timeout" href="#opt-timeout" title="#opt-timeout">`timeout`</a> | Defines the maximum duration for a request to the authentication server. Parsed as a Go duration string (e.g. `30s`, `1m`). Setting it to `0` disables the timeout.                                                                                                                                                                     | "30s" | No      |
